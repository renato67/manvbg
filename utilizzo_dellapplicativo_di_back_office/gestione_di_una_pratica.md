...
la scheda permette la selezione di un documento contenenti dei campi precedentemente definiti, allegati al movimento in fase di setting della procedura. Se tali documenti non sono presenti \(come si vede nel messaggio\) è possibile \(spuntando il flag
