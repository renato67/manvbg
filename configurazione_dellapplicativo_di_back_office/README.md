...
Un valido esempio di flusso generato é rappresentato dalle immagini contenute in questa sezione:[](utilizzo_dellapplicativo_di_back_office/gestione_di_una_pratica.md)
