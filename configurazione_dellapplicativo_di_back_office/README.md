...
Un valido esempio di flusso generato é rappresentato dalle immagini contenute in questa sezione: [sezione 6](gestione_di_una_pratica.md#Gestione di una pratica)
Come si può vedere:
