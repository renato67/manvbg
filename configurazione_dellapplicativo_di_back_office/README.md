...
Un valido esempio di flusso generato é rappresentato dalle immagini contenute in questa sezione: [sezione 6](utilizzo_dellapplicativo_di_back_office.md#gestione_di_una_pratica)
Come si può vedere:
